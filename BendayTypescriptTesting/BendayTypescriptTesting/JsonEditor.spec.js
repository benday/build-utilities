...
const fs = require("fs");
describe('JsonEditor', () => {
    var _SystemUnderTest;
    const _PathToAppSettingsFileWithValues = './sample-files/appsettings.json';
    const _PathToAppSettingsFileWithoutValues = './sample-files/appsettings-no-connection-strings.json';
    const _PathToAppSettingsTempFile = './sample-files/appsettings-temp.json';
    beforeEach(function () {
        _SystemUnderTest = null;
        _SystemUnderTest = new JsonEditor_1.JsonEditor();
    });
...
//# sourceMappingURL=JsonEditor.spec.js.map